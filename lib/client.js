...
function mountBrowser(onClose) {
	...
	root.render((0, react.createElement)(WslBrowser, {
		onClose: cleanup,
		onRegistered: () => {}
	}));
	return cleanup;
	...
	function ensureButton() {
		...
		for (const btn of document.querySelectorAll("button[aria-label]")) {
			...
			if (labels.includes(label)) {
				...
				b.title = "WSL 工作区";
				b.innerHTML = "<svg width=\"16\" height=\"16\" viewBox=\"0 0 16 16\" fill=\"none\" aria-hidden=\"true\"><path fill=\"currentColor\" d=\"M5.4 2.1 4.7 2.5 5.4 2.1Zm7.6 9.8h-6v1h6v-1ZM6.5 1.9v3.6h1V1.9h-1Zm3.4 3.6V1.9h-1v3.6h1Zm-4.6 3.7h3v-1h-3v1Z\" transform=\"translate(1.5 1)\" opacity=\"0.9\"/><path fill=\"currentColor\" d=\"M2.5 1.5h4.2v1H3.5v11h9v-4.2h1V13a1.5 1.5 0 0 1-1.5 1.5h-9A1.5 1.5 0 0 1 2.5 13V3a1.5 1.5 0 0 1 1.5-1.5Zm7 8V6.3h3v1h-2v2.2h-1Z\" transform=\"translate(1.5 1)\"/></svg>";
