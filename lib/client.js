...
//#endregion
//#region lib/client/wsl-locale.js
/**
...
*/
function WslBrowser({ onClose, onRegistered, locale }) {
			...
			children: [
				...
				(0, react_jsx_runtime.jsxs)("div", {
					...
					children: [(0, react_jsx_runtime.jsx)("button", {
						...
						className: "dshwsl-btn",
						onClick: onClose,
						children: registered ? L("done") : L("close")
...
function apply(ctx) {
	...
	const t = ctx.locale?.bind?.("dsh-wsl") ?? ((key) => key);
