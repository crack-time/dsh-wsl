...
import { formatText, makeT } from './wsl-locale.js';
export function WslBrowser({ onClose, onRegistered, locale }) {
    ...
    return (_jsx("div", { className: "dshwsl-modal", onClick: onClose, children: _jsxs("div", { className: "dshwsl-card", onClick: (e) => e.stopPropagation(), children: [_jsxs("div", { className: "dshwsl-head", children: [_jsx("h3", { className: "dshwsl-title", children: L('title') }), _jsx("button", { type: "button", className: "dshwsl-close", onClick: onClose, "aria-label": "close", children: "\u00D7" })] }), _jsxs("div", { className: "dshwsl-row", children: [_jsx("span", { className: "dshwsl-label", children: L('distro') }), _jsx("select", { className: "dshwsl-select", value: distro, onChange: (e) => void onDistroChange(e.target.value), children: distros.map((d) => _jsx("option", { value: d, children: d }, d)) })] }), _jsxs("div", { className: "dshwsl-row", children: [_jsx("span", { className: "dshwsl-label", children: L('path') }), _jsx("span", { className: "dshwsl-path", title: path, children: path })] }), _jsxs("div", { className: "dshwsl-row", children: [_jsx("button", { type: "button", className: "dshwsl-up", onClick: () => void load(distro, parent(path)), children: L('up') }), _jsxs("div", { className: "dshwsl-btnbar", children: [_jsx("input", { className: "dshwsl-input", placeholder: L('folderName'), value: newName, onChange: (e) => setNewName(e.target.value), onKeyDown: (e) => { if (e.key === 'Enter')
                                        void createFolder(); } }), _jsx("button", { type: "button", className: "dshwsl-btn", onClick: () => void createFolder(), children: L('create') })] })] }), (loading && entries.length === 0) && _jsx("div", { className: "dshwsl-status", children: L('loading') }), error && _jsx("div", { className: "dshwsl-status dshwsl-error", children: error }), registered && _jsxs("div", { className: "dshwsl-status dshwsl-ok", children: ["\u2713 ", L('registered')] }), _jsxs("div", { className: "dshwsl-list", children: [!loading && entries.length === 0 && !error && _jsx("div", { className: "dshwsl-empty", children: L('empty') }), entries.map((entry) => (_jsxs("div", { className: `dshwsl-item${entry.isDir ? '' : ' file'}`, onClick: () => enter(entry), children: [_jsx("span", { className: "dshwsl-icon", children: entry.isDir ? '📁' : '📄' }), _jsx("span", { children: entry.name })] }, entry.linuxPath)))] }), _jsxs("div", { className: "dshwsl-foot", children: [_jsx("button", { type: "button", className: "dshwsl-btn", onClick: onClose, children: registered ? L('done') : L('close') }), !registered && (_jsx("button", { type: "button", className: "dshwsl-btn primary", disabled: loading || !distro || !path, onClick: () => void register(), children: L('register') }))] })] }) }));
}
